export default {
  translation: {
    ...
    'Show others this was sent via Fevela': 'Pokaż innym, że zostało to wysłane przez Fevela',
    ...
    Reactions: 'Odzewy',
    Zaps: 'Zapy',
    'Enjoying Fevela?': 'Podoba ci się Fevela?',
    'Your donation helps me maintain Fevela and make it better! 😊':
      'Twoja darowizna pomoże mi utrzymać i ulepszać Fevela! 😊',
    ...
    GroupedNotesPin: 'Przypnij użytkownika',
    GroupedNotesUnpin: 'Odepnij użytkownika',
    GroupedNotesBury: 'Ukryj użytkownika',
    GroupedNotesUnbury: 'Odkryj użytkownika',
    GroupedNotesMarkUnread: 'Oznacz jako nieprzeczytane',
