export default {
  translation: {
    ...
    'Show others this was sent via Fevela': '이 노트가 Fevela을 통해 전송되었음을 표시',
    ...
    Reactions: '반응',
    Zaps: '잽',
    'Enjoying Fevela?': 'Fevela이 마음에 드시나요?',
    'Your donation helps me maintain Fevela and make it better! 😊':
      '후원해주시면 Fevela을 더 잘 유지하고 발전시킬 수 있습니다! 😊',
