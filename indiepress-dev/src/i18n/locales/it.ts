export default {
  translation: {
    ...
    'Show others this was sent via Fevela':
      'Mostra agli altri che questo è stato inviato tramite Fevela',
    ...
    Reactions: 'Reazioni',
    Zaps: 'Zaps',
    'Enjoying Fevela?': 'Ti sta piacendo Fevela?',
    'Your donation helps me maintain Fevela and make it better! 😊':
      'La tua donazione mi aiuta a mantenere Fevela e a migliorarlo! 😊',
    ...
    ShowOnlyFirstLevelReplies: 'Mostra solo le risposte di primo livello',
    'Relay sets': 'Set di Relay',
    ...
    Grouped: 'Gruppo',
    GroupedNotesEnable: 'Abilita modalità note raggruppate',
    GroupedNotesCompact: 'Vista compatta: mostra solo autori',
    GroupedNotesShowPreview: "Mostra anteprima dell'ultima nota",
    GroupedNotesIncludeReplies: 'Includi risposte',
    GroupedNotesShowOnlyFirstLevelReplies: 'Mostra solo risposte di primo livello',
    GroupedNotesFilter: 'Cerca utenti...',
    GroupedNotesTimeframe:
      'Mostrami un riepilogo per singoli utenti di quello che è successo negli ultimi',
    GroupedNotesWordFilter: 'Filtra note con queste parole (separate da virgole):',
    GroupedNotesWordFilterPlaceholder: 'es. nostr, bitcoin, gm',
    GroupedNotesFilterMore: 'Filtra utenti che hanno pubblicato più di X note nel periodo di tempo',
    GroupedNotesDays: 'Giorni',
    GroupedNotesHours: 'Ore',
    GroupedNotesDisabled: 'Disabilitato',
    GroupedNotesPin: 'Fissa utente',
    GroupedNotesUnpin: 'Rimuovi utente',
    GroupedNotesBury: 'Seppellisci utente',
    GroupedNotesUnbury: 'Disseppellisci utente',
    GroupedNotesMarkUnread: 'Segna come non letto',
