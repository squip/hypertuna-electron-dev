export default {
  translation: {
    ...
    'Show others this was sent via Fevela': 'Montrer aux autres que cela a été envoyé via Fevela',
    ...
    Reactions: 'Réactions',
    Zaps: 'Zaps',
    'Enjoying Fevela?': 'Vous appréciez Fevela ?',
    'Your donation helps me maintain Fevela and make it better! 😊':
      "Votre don m'aide à maintenir Fevela et à l'améliorer ! 😊",
    ...
    GroupedNotesHours: 'Heures',
    GroupedNotesDisabled: 'Désactivé',
    GroupedNotesPin: "Épingler l'utilisateur",
    GroupedNotesUnpin: "Désépingler l'utilisateur",
    GroupedNotesBury: "Enterrer l'utilisateur",
    GroupedNotesUnbury: "Déterrer l'utilisateur",
    GroupedNotesMarkUnread: 'Marquer comme non lu',
