export default {
  translation: {
    ...
    'Show others this was sent via Fevela': 'Mostrar aos outros que isso foi enviado via Fevela',
    ...
    Reactions: 'Reações',
    Zaps: 'Zaps',
    'Enjoying Fevela?': 'Gostando do Fevela?',
    'Your donation helps me maintain Fevela and make it better! 😊':
      'Sua doação me ajuda a manter o Fevela e torná-lo melhor! 😊',
    ...
    ShowOnlyFirstLevelReplies: 'Mostrar apenas respostas de primeiro nível',
    'Relay sets': 'Conjuntos de Relé',
    ...
    GroupedNotesShowPreview: 'Mostrar pré-visualização da última nota',
    GroupedNotesIncludeReplies: 'Incluir respostas',
    GroupedNotesShowOnlyFirstLevelReplies: 'Mostrar apenas respostas de primeiro nível',
    GroupedNotesFilter: 'Pesquisar utilizadores...',
    GroupedNotesTimeframe:
      'Mostrar-me um resumo para utilizadores individuais do que aconteceu nos últimos',
    GroupedNotesWordFilter: 'Filtrar notas com estas palavras (separadas por vírgulas):',
    ...
    GroupedNotesPin: 'Fixar utilizador',
    GroupedNotesUnpin: 'Desafixar utilizador',
    GroupedNotesBury: 'Enterrar utilizador',
    GroupedNotesUnbury: 'Desenterrar utilizador',
